...
clang -std=c99 -Wall -Werror -Wpedantic -Wextra -Wfloat-equal -Wfloat-conversion -fsanitize=memory -fno-omit-frame-pointer -fPIE -O0 -g -c array.c 
...
clang main.o array.o matrix.o -o app.exe -lm -fsanitize=memory